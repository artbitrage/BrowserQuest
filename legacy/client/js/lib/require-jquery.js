...
(() => {
  ...
  function newContext(contextName) {
    ...
    context = {
      ...
      requireDefined: (moduleName, relModuleMap) =>
        makeModuleMap(moduleName, relModuleMap).fullName in defined,

      requireSpecified: (moduleName, relModuleMap) =>
        makeModuleMap(moduleName, relModuleMap).fullName in specified,
      ...
      completeLoad: (moduleName) => {
        ...
        if (args) {
          ...
          callDefMain([
            moduleName,
            [],
            moduleName === 'jquery' && typeof jQuery !== 'undefined' ? () => jQuery : null,
          ]);
        }
...
((window, undefined) => {
  ...
  var jQuery = (() => {
    ...
    jQuery.extend({
      ...
      isWindow: (obj) => obj && typeof obj === 'object' && 'setInterval' in obj,

      isNaN: (obj) => obj == null || !rdigit.test(obj) || isNaN(obj),
  ...
  jQuery.support = (() => {
    ...
    if (document.defaultView && document.defaultView.getComputedStyle) {
      ...
      support.reliableMarginRight =
        (Number.parseInt(
          (document.defaultView.getComputedStyle(marginDiv, null) || { marginRight: 0 })
            .marginRight,
          10,
        ) || 0) === 0;
    }
  ...
  var rnamespaces = /\.(.*)$/,
    ...
    rspaces = / /g,
    rescape = /[^\w\s.|`]/g,
    fcleanup = (nm) => nm.replace(rescape, '\\$&');
      ...
      setup: function (data, namespaces) {
        if (!jQuery.nodeName(this, 'form')) {
          jQuery.event.add(this, 'click.specialSubmit', function (e) {
            ...
            var elem = e.target,
              type =
                jQuery.nodeName(elem, 'input') || jQuery.nodeName(elem, 'button') ? elem.type : '';
    ...
    if (val > 0) {
      if (extra !== 'border') {
        jQuery.each(which, function () {
          ...
          if (extra === 'margin') {
            val += Number.parseFloat(jQuery.css(elem, extra + this)) || 0;
          } else {
  ...
  jQuery.extend({
    ...
    easing: {
      linear: (p, n, firstNum, diff) => firstNum + diff * p,
      swing: (p, n, firstNum, diff) => (-Math.cos(p * Math.PI) / 2 + 0.5) * diff + firstNum,
    },
  ...
  jQuery.each(['Height', 'Width'], (i, name) => {
    ...
    jQuery.fn['inner' + name] = function () {
      var elem = this[0];
      return elem && elem.style ? Number.parseFloat(jQuery.css(elem, type, 'padding')) : null;
    };
