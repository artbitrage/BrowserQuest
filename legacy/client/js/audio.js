define(['area'], (Area) => {
  var AudioManager = Class.extend({
    ...
    getSound: function (name) {
      ...
      var sound = _.detect(this.sounds[name], (sound) => sound.ended || sound.paused);
    ...
    getSurroundingMusic: function (entity) {
      var music = null,
        area = _.detect(this.areas, (area) => area.contains(entity));
